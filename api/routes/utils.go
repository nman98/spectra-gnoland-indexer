...
func RegisterUtilsRoutes(api huma.API) {
	huma.Post(api, v1+"/utils/base64url/encode", handlers.ConvertFromBase64toBase64Url,
	...
	huma.Post(api, v1+"/utils/base64url/decode", handlers.ConvertFromBase64UrlToBase64,
		func(op *huma.Operation) {

...
func RegisterBlocksRoutes(api huma.API, h *handlers.BlocksHandler, m *handlers.InMemoryHandler) {
	...
	huma.Get(api, v1+"/blocks/stats/avg_time", m.GetAvgBlockProdTime,
		func(op *huma.Operation) {

...
func RegisterTransactionsRoutes(api huma.API, h *handlers.TransactionsHandler) {
	huma.Get(api, v1+"/transactions", h.GetTransactionsByCursor,
	...
	huma.Get(api, v1+"/transactions/stats/count/hourly", h.GetTotalTxCountByHour,
		func(op *huma.Operation) {
	...
	huma.Get(api, v1+"/transactions/stats/volume/daily", h.GetVolumeByDate,
		func(op *huma.Operation) {
	...
	huma.Get(api, v1+"/transactions/stats/volume/hourly", h.GetVolumeByHour,
		func(op *huma.Operation) {

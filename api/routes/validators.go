...
func RegisterValidatorsRoutes(api huma.API, h *handlers.ValidatorsHandler) {
	huma.Get(api, v1+"/validators/{validator_address}/signing/recent", h.GetValidatorSigning24h,
	...
	huma.Get(api, v1+"/validators/{validator_address}/signing/hourly", h.GetValidatorSigningByHour,
		func(op *huma.Operation) {
